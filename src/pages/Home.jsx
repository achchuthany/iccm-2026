...
import paymentPdf from "../../ICCM-001.pdf";
    ...
    <>
      ...
      >
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 px-4 py-3">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              The payment instructions below are shown directly from the provided PDF.
            </p>
            <a
              href={paymentPdf}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold transition-colors"
            >
              Open PDF
            </a>
          </div>
          ...
          <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
            <iframe
              src={paymentPdf}
              title="ICCM payment information"
