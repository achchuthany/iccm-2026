      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-gray-700 dark:text-gray-300 text-lg mb-12">
            The detailed conference programme will be announced closer to the
            event date.
          </p>
          ...
          <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700 dark:text-gray-300">
                  Quality Research Network Meetings
                </span>
              </div>
              <div className="flex items-start">
                <svg
            ...
            <div className="mb-8">
              ...
              <div className="relative bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-32 h-32 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-32 h-32 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      <h5 className="font-semibold text-gray-900 dark:text-white mb-1">
                        Assoc. Prof. Sutha Kanapathipillai
                      </h5>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                        Deakin University, Australia
                      </p>
                      <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">
                        Governance, Policy, and Multi-Stakeholder Collaboration
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h5 className="font-semibold text-gray-900 dark:text-white mb-1">
                        Dr. Gajendra Liyanaarachchi
                      </h5>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                        University of Portsmouth, England
                      </p>
                      <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">
                        Inclusive Economic Growth, Entrepreneurship, and Local
                        Livelihoods
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h5 className="font-semibold text-gray-900 dark:text-white mb-1">
                        Mr. Sampath Jayawardena
                      </h5>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                        Senior Director, Ernst & Young
                      </p>
                      <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">
                        Sustainable Infrastructure and Climate-Resilient Regions
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">
                        Innovation, Knowledge, and Digital Transformation for
                        Sustainability
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      Shaping Regions for Resilience, Inclusion, and
                      Sustainability
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-8 p-6 bg-blue-50 dark:bg-gray-800 rounded-lg">
            <p className="text-gray-700 dark:text-gray-300 text-center">
              <strong>Note:</strong> This is a tentative schedule. The final
              programme with detailed session information will be published
