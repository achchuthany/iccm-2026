            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  <svg className="w-8 h-8 text-blue-600 dark:text-blue-400 mr-4 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+94212223610" className="text-blue-600 dark:text-blue-400 hover:underline text-lg">
                      +94 21 222 3610
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:iccm@maco.jfn.ac.lk" className="text-blue-600 dark:text-blue-400 hover:underline text-lg">
                      iccm@maco.jfn.ac.lk
                    </a>
                  </div>
                </div>
