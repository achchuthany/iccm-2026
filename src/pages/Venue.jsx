          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="text-center mb-8">
              <p className="text-xl text-gray-700 dark:text-gray-300 mb-2">
                <strong>Venue Name:</strong> To Be Announced
              </p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6">
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>Public transportation details TBA</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Airport shuttle information TBA</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                  </svg>
                  <span>Parking facilities available</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6">
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>Hotel recommendations TBA</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                  </svg>
                  <span>Special conference rates available</span>
                </li>
              </ul>
            </div>
          </div>
